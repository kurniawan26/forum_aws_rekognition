defmodule ForumAwsRekognitionWeb.UserLive.Registration do
  use ForumAwsRekognitionWeb, :live_view

  alias ForumAwsRekognition.Accounts
  alias ForumAwsRekognition.Accounts.User
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: ForumAwsRekognitionWeb.UserAuth.signed_in_path(socket))}
  end
